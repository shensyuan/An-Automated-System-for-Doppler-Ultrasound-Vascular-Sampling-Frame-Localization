...
public class MainActivity extends AppCompatActivity {
  ...
  // 輸入的大小
  private static final int LR_IMAGE_HEIGHT = 886;//562
  private static final int LR_IMAGE_WIDTH = 720;
  private static final int SR_IMAGE_HEIGHT = 886;//562;
  private static final int SR_IMAGE_WIDTH = 720;

  //輸入的三個影像
  private static final String LR_IMG_1 = "old.jpg";//"n1.png"; 這邊是信中的影像 改名比較好打XD
  private static final String LR_IMG_2 = "young.jpg";//"n2.png";
  private static final String LR_IMG_3 = "liang.jpg";//"n3.png";
    ...
    superResolutionButton.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            ...
            int[] superResRGB = doSuperResolution(lowResRGB); //分割
